...
def print_results(suite_result: SuiteResult, verbose: bool = False) -> None:
    ...
    table.add_column("Pass Rate", justify="right", min_width=8)
    table.add_column("95% CI", justify="right", min_width=15, no_wrap=True)
    table.add_column("Avg Cost", justify="right", min_width=8)
    table.add_column("Avg Latency", justify="right", min_width=10)
    table.add_column("Avg Tokens", justify="right", min_width=8)
...
def print_comparison(
    ...
    """
    from agentrial.metrics.statistical import detect_regression
