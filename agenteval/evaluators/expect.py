...
from agenteval.types import AgentOutput, TrajectoryStep
...
class ExpectationBuilder:
    ...
    def tool_called(
        ...
        Returns:
            Self for chaining.
        """
        from agenteval.evaluators.exact import tool_called
...
class OutputExpectation:
    ...
    def contains(self, *substrings: str) -> "OutputExpectation":
        ...
        Returns:
            Self for chaining.
        """
        from agenteval.evaluators.exact import contains
    ...
    def matches(self, pattern: str) -> "OutputExpectation":
        ...
        Returns:
            Self for chaining.
        """
        from agenteval.evaluators.exact import regex_match
...
class StepExpectation:
    ...
    def tool_name(self, expected: str) -> "StepExpectation":
        ...
        from agenteval.types import StepType
